...
const players: PlayerState[] = [
    {
        name: "Player2", status: "isReserve", subOffTime: 0,
        timePlayed: 5,
        timesAsSub: 0
    },
    {
        name: "Player1", status: "isReserve", subOffTime: 1,
        timePlayed: 3,
        timesAsSub: 0
    },
    {
        name: "Player4", status: "isReserve", subOffTime: 2,
        timePlayed: 2,
        timesAsSub: 0
    },
    {
        name: "Player3", status: "isReserve", subOffTime: 3,
        timePlayed: 4,
        timesAsSub: 0
    },
];
